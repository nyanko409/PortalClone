...
private:
	...
	static ID3D11DepthStencilState* m_DepthStateStencilOnlyBackface;
	static ID3D11DepthStencilState* m_DepthStateStencilCompEqual;
...
public:
	static void Init();
	static void Uninit();
	static void Begin(std::vector<uint8_t> renderPass, bool clearRTV, bool clearDepth, bool clearStencil, ID3D11DepthStencilView* depthStencilView);
	static void End();
