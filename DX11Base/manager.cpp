...
void CManager::Draw()
{
	...
	{
		CRenderer::Begin(m_renderPasses[i].targetOutput, m_renderPasses[i].clearRTV, m_renderPasses[i].clearDepth, m_renderPasses[i].clearStencil, m_renderPasses[i].depthStencilView);
